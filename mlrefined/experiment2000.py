...
for file in files:
    for isEight in range(2):
        ...
        small_maze = lib.gridworld_enviro.environment(world_size = name, world_type = 'maze', height=height, width=width, goal=goal, start=start, training_episodes = 2000, isEight = isEight)
